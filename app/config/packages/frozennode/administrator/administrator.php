...
return array(
	 ...
	 */
	'menu' => array(
		'用户管理' => array('user_all', 'user_role'),
		'首页' => array('con_home_source',/*'stru_home_banner', 'stru_home_content'*/),
		'恋语微言' => array('stru_love_banner', 'stru_love_content', 'stru_love_wording_banner', 'stru_love_wording_content'),
		'stru_live_content',
		'文章管理' => array('con_page', 'con_media', 'con_comment', 'con_weixin'),
		'设置' => array('con_column', 'stru_column', 'stru_type', 'stru_template', 'settings.site'),
	),
